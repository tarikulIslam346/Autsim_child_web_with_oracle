...
<h1> Delete value from student</h1>
  <form class="form-horizontal" role="form" action="StudentPro.php" method="post">
   <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" id="symptomps"  name="class" placeholder="Enter class" >
      </div>
     <br/>
