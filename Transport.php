...
<button type="button" class="btn btn-default" >Previous</button></a>
  ...
  <div class="col-sm-4"><h1> Insert value for Transport</h1>
  <form class="form-horizontal" role="form" action="TransportPro.php" method="post">
   <div class="form-group">
      <label class="control-label col-sm-2" for="user">Serial No:</label>
      <div class="col-sm-10">
	...
	<br/>
	<div class="form-group">
      <label class="control-label col-sm-2" for="user">Vehicle:</label>
      <div class="col-sm-10">
        <input type="text" class="form-control" id="salary"  name="v" placeholder="Enter salary" >
      </div>
	  ...
	  <br/>
	  <div class="form-group">
      <label class="control-label col-sm-2" for="user">Route:</label>
      <div class="col-sm-10">
        <input type="text" class="form-control" id="admin"  name="r" placeholder="Enter Admin ID" >
      </div>
	   </div>
