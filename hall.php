...
<button type="button" class="btn btn-default" >Previous</button></a>
  ...
  <div class="col-sm-4"><h1> Insert value for Hall</h1>
  <form class="form-horizontal" role="form" action="hallPro.php" method="post">
   <div class="form-group">
      <label class="control-label col-sm-2" for="user">Name:</label>
      <div class="col-sm-10">
        <input type="text" class="form-control" id="type" name="name" placeholder="Enter ID" >
      </div>
    </div>
	<br/>
	<div class="form-group">
      <label class="control-label col-sm-2" for="user">Seat:</label>
      <div class="col-sm-10">
        <input type="text" class="form-control" id="salary"  name="seat" placeholder="Enter salary" >
      </div>
	  ...
	  <br/>
	  <div class="form-group">
      <label class="control-label col-sm-2" for="user">Location:</label>
      <div class="col-sm-10">
        <input type="text" class="form-control" id="admin"  name="loc" placeholder="Enter Admin ID" >
      </div>
	   </div>
